 ...
 * @author Jeky
 */
public abstract class BlockTemplateTag extends TemplateTag {

    public BlockTemplateTag(String startTagName, String endTagName) {
        super(startTagName, new String[]{}, endTagName);
    }
            ...
            switch (n.getType()) {
                ...
                case TAG_START:
                    ...
                    if (tagName.equals(endTagName)) {
                        collectTagNodes(nodes, endTagName);
                        return tag;
                    } else {
